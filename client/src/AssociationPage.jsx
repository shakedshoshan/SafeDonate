...
const AssociationPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchNegativeInfo = async (associationNumber) => {
      console.log(
        "Fetching negative information for association:",
        associationNumber
      );
      try {
  ...
  return (
    <div className="association-page">
      ...
      <div className="right-section">
        {/* Circle Image with NPO Initials */}
        ...
        <div className="npo-place">
          {association["ישוב"] || "No place available"}
        </div>
        ...
        {/* Donate Button */}
        <button className="donate-button">לתרומה</button>
      </div>
