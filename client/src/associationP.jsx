        ...
        const fetchAssociation = async () => {
            try {
                ...
                if (tokenResponse.status === 200) {
                    ...
                    const cachedData = localStorage.getItem(`assoc_${associationNumber}`);
                    if (cachedData) {
                        setAssociation(JSON.parse(cachedData)); // was to setAssociationData
                        setLoading(false);
                        return;
                    }
                    ...
                    try {
                        ...
                        if (response.data.result.records.length > 0) {
                            ...
                            localStorage.setItem(`assoc_${associationNumber}`, JSON.stringify(associationData));
        ...
        if (association) {
            const fetchScrapingData = async () => {
                ...
                try {
                    ...
                    const cachedScrapingData = localStorage.getItem(`scraping_${associationNumber}`);
                    ...
                    if (response.data.length > 0) {
                        ...
                        localStorage.setItem(`scraping_${associationNumber}`, JSON.stringify(scrapedData));
